    ...
    public function getIngredientDetails($recipe, $business_id, $location_id = null)
    {
        ...
        // try{
            ...
            $ingredient_variations = MfgRecipeIngredient::where('mfg_recipe_id', $recipe->id)
                                ...
                                ->get();
            // dd($ingredient_variations);
            $arry_list = [];
            //Format variation data
            $ind = 0;
            // if(count($ingredient_variations) > 0){
                foreach ($ingredient_variations as $ingredient_variation) {
                    ...
                    $new_total_price = $variation->sell_price_inc_tax * $ingredient_variation->quantity; 
                ...
                return $ingredients;
            // }else{
            //     // echo '<br>not in loop ------'.$ind;
            //     array_push($arry_list, $recipe->id);
            //     return $arry_list;
            // }
