...
<table class="table table-striped table-th-green text-center" id="ingredients_for_unit_recipe_table">
	...
	<tfoot>
		<tr>
			<td colspan="5" style="text-align: right;"><strong>@lang('manufacturing::lang.ingredients_cost')</strong></td>
		...
		{{-- <tr>
		    <td colspan="5" style="text-align: right;"><strong>Unit Rate</strong></td>
			<td>
