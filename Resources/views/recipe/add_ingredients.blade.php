	...
	<div class="box box-solid">
	  <div class="container">
		<div class="row"> 
        		...
        		<h4 class="box-title"><strong> @lang('sale.product'): </strong></h4>
        	    </div>
        	    <div class="col-md-10 text-left">
        		<h4 class="box-title"><strong>	{{$variation->product_name}} @if($variation->product_type == 'variable') - {{$variation->product_variation_name}} - {{$variation->name}} @endif </strong></h4>
        		</div>
        		
                <div class="col-md-2 text-right">
		    	<h5 class="box-title"><strong>Gross Weight:</strong></h5>
    			</div>
    			<div class="clearfix"></div>
    			<div class="col-md-10 text-left">
			   <h5 class="box-title"> <strong>{{$variation->gross_weight}} </strong></h5>
			   	<!--<h5 class="box-title"><strong>	{{$variation->product_name}} @if($variation->product_type == 'variable') - {{$variation->product_variation_name}} - {{$variation->name}} @endif </strong></h5>-->
			    </div>
			    <br>
			    
			    
	           <div class="col-md-2 text-right">
			    <h5 class="box-title"><strong>Net Weight:</strong></h5>
		       </div>
    		  <div class="col-md-10 text-left">
    		      <h5 class="box-title">
    			<strong> {{$variation->net_weight}}</strong>
    			 </h5>
    		   </div>
		...
		<div class="box-body">
			...
			<div class="row">
				<div class="col-sm-12 fixed-button">
                 ...
                 <div class="btn-group ">
					<button type="submit" class="btn-big btn-primary ">Save & Close</button>
