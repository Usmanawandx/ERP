            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    @can('manufacturing.access_production')
                        ...
                        <li @if(request()->segment(2) == 'multi-production-create' || request()->segment(2) == 'multiproduction_index') class="active" @endif><a href="{{action('\Modules\Manufacturing\Http\Controllers\ProductionController@multiproduction_index')}}">@lang('Multiple Production')</a></li>
